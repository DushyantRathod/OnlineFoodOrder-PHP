...
<header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/sitelogoNew1.png" style="width: 10%; height: 10%; margin-left:-100px;" alt=""> </a>
            ...
            <section class="contact-page inner-page">
               ...
               <div class="container ">
                  ...
                  <div class="row ">
                     <div class="col-md-12">
                        <div class="widget" >
                        <!-- <img style="float: right;width: 50px; height: 50px;" src="images\wrong.png"> -->
                                 ...
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
									 ...
									 <div class="form-group col-sm-12">
                                       <label for="exampleTextarea">Delivery Addresss</label>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>LDCE, Ahmedabad, Gujarat 380015</p>
                                    <h5>Phone: 96xxxxxxxx</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>It is our project for web programming subject.</p>
                                </div>
                    </div>
                </div>
